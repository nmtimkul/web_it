...
$largeur_source = imagesx($copy); // The imagesx and imagesy functions return the width and height of an image
...
// puts the logo (source) in the destination image (the photo)
imagecopymerge_alpha($destination, $copy, $destination_x, $destination_y, 0, 0, $largeur_source, $hauteur_source, 100);

// displays the destination image that has been merged with the logo
